...
RULES = {
    "n40": {
        ...
        "Stop": "DAILY from-entry FIXED −10% hard stop — SELL if the held name's LOW pierces entry × 0.90 (checked every trading day, not just rebalance days). Re-tuned from −12% on 2026-06-13. Set STOP_PCT=0 to disable.",
...
def write_ledger(model: str):
    ...
    rows = ["# " + model + " — trade ledger (2021-03-01 → 2026-06-12)", "",
