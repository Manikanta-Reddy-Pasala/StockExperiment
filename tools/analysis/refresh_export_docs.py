...
WIN = ("Backtest window: **2021-01-01 → 2026-05-29** (₹10L capital; full ~5.4-year cycle: 2021 bull, "
...
def write_ledger(model: str):
    ...
    rows = ["# " + model + " — trade ledger (2021-01-01 → 2026-05-29)", "",
