...
MODELS = {
    ...
    "momentum_pseudo_n100_adv": {
        "title": "Pseudo-N100 (top-100 ADV from N500 − Smallcap) + uptrend + MAX_PRICE≤₹3,000. Monthly + mid-month rotation, hold while in top-5 by 30d ret.",
        ...
        "logic": [
            ...
            "Rank by 30-day return, hold rank-1 while it stays in the top-5",
            "Rebalance: 1st trading day of month + mid-month day-15 check (rotate only if rank-1 leads held by ≥3pp)",
        ],
        "data": "Fyers (split-adjusted cont_flag=1)",
        "live": False,
    },
