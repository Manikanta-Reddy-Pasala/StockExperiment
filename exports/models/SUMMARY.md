...
| 5 | `n20_daily_30d_mc1_uptrend` | Top-20 ADV + uptrend filter | Daily | ₹1.70 Cr | **+157.27%** | 50.61% | ❌ |
...
| `n20_daily_30d_mc1_uptrend` | Top-20 ADV + close>200d SMA gate | Smallest universe (20 vs 100); strictest uptrend filter; daily PIT rebuild |
...
│   └── monthly.csv
└── n20_daily_30d_mc1_uptrend/
    ├── SUMMARY.md                        Top winners + losses tables
    └── TRADE_LEDGER.md
```
