...
|--:|---|---|---|---:|---:|---:|:-:|
| 1 | `momentum_n100_top5_max1` | Real NSE Nifty 100 (104 stocks) | Monthly | ₹0.37Cr | **+55.35%** | 48.99% | ✅ |
| 2 | `momentum_pseudo_n100_adv` | Top-100 ADV from N500 (yearly PIT) | Monthly | ₹0.98Cr | **+113.86%** | 36.44% | ❌ |
| 3 | `midcap_narrow_60d_breakout` | Pseudo-midcap MINUS Large (Mid+Small only) | Event-driven | ₹0.33Cr | **+48.17%** | 15.15% | ❌ |
| 4 | `finnifty_ic_otm4_w300_lots5` | FINNIFTY options (no equity) | Monthly Iron Condor | ₹1.11 Cr (scaled) | **+123%** | 13.88% | ❌ |
| 5 | `n20_daily_v2_large_only` | Top-20 ADV + uptrend + **NSE Nifty 100** filter | Daily | ₹1.70Cr | **+157.04%** | **27.24%** | ❌ |
