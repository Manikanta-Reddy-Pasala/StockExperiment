...
| Metric | Value |
|---|---|
| Final NAV (₹10L start) | ₹80,141,503 |
| Total return | +7914.1% |
| CAGR (annualized) | +129.3% |
| Max drawdown | 35.2% |
| Calmar | 3.68 |
| Trades | 62 (39W / 23L) · 63% win |
| Total charges (real Fyers CNC, deducted) | ₹3,981,454 |
...
**Open position at window end:** HFCL qty 466318 entry ₹180.0 on 2026-06-02 (unrealized +0)
