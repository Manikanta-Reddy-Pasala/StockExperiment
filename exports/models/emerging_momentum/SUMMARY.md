...
| Metric | Value |
|---|---|
| Final NAV (₹10L start) | ₹7,170,073 |
| Total return | +617.0% |
| CAGR (annualized) | +45.6% |
| Max drawdown | 37.7% |
| Calmar | 1.21 |
| Trades | 62 (36W / 26L) · 58% win |
...
**Open position at window end:** BHEL [mid] qty 17204 entry ₹377.05 on 2026-05-04 (unrealized +682,999)
