...
- **Target hits / Stop hits / Partials:** 4 / 42 / 7
- **Avg / median % per leg:** 0.61% / -0.97%
- **Sum % (uncompounded):** 32.16%

## Direction × Alert breakdown

| Bucket | Legs | Win | Win% | Tgt | SL | Prt | Avg % | Sum % |
|--------|------|-----|------|-----|----|-----|-------|-------|
| BUY (all) | 20 | 3 | 15.0% | 1 | 19 | 0 | -0.98% | -19.6% |
| BUY @ 2nd Alert (retest1) | 1 | 0 | 0.0% | 0 | 1 | 0 | -2.29% | -2.3% |
| BUY @ 3rd Alert (retest2) | 19 | 3 | 15.8% | 1 | 18 | 0 | -0.91% | -17.3% |
| SELL (all) | 33 | 14 | 42.4% | 3 | 23 | 7 | 1.57% | 51.8% |
| SELL @ 2nd Alert (retest1) | 3 | 2 | 66.7% | 1 | 1 | 1 | 4.55% | 13.7% |
| SELL @ 3rd Alert (retest2) | 30 | 12 | 40.0% | 2 | 22 | 6 | 1.27% | 38.1% |
| retest1 (combined) | 4 | 2 | 50.0% | 1 | 2 | 1 | 2.84% | 11.4% |
| retest2 (combined) | 49 | 15 | 30.6% | 3 | 40 | 6 | 0.42% | 20.8% |
...
| Stop hit — per-position SL triggered | 2025-05-21 10:15:00 | 1274.00 | 1292.75 | 1291.49 | SL hit (close<static) qty=1.00 sl=1287.00 alert=retest2 |
| Stop hit — per-position SL triggered | 2025-05-21 11:15:00 | 1274.10 | 1289.02 | 1289.91 | Force close (CROSSOVER_FLIP) qty=1.00 alert=retest2 |
| Stop hit — per-position SL triggered | 2025-05-21 11:15:00 | 1274.10 | 1289.02 | 1289.91 | Force close (CROSSOVER_FLIP) qty=1.00 alert=retest2 |
| Stop hit — per-position SL triggered | 2025-05-21 11:15:00 | 1274.10 | 1289.02 | 1289.91 | Force close (CROSSOVER_FLIP) qty=1.00 alert=retest2 |
| Stop hit — per-position SL triggered | 2025-05-21 11:15:00 | 1274.10 | 1289.02 | 1289.91 | Force close (CROSSOVER_FLIP) qty=1.00 alert=retest2 |
...
### Cycle 10 — SELL (started 2025-06-13 15:15:00)
...
| Second Entry (SELL) — retest2 break (cap 3 attempts) | 2025-06-17 10:30:00 | 1321.20 | 1323.89 | 1327.22 | SELL ENTRY2 attempt 2/4 (v1.4 edge cross+close) |
| Stop hit — per-position SL triggered | 2025-06-17 11:15:00 | 1331.00 | 1325.31 | 1327.57 | SL hit (close>static) qty=1.00 sl=1330.90 alert=retest2 |
...
### Cycle 13 — BUY (started 2025-06-20 12:15:00)
...
### Cycle 17 — BUY (started 2025-07-11 14:15:00)
...
| ALERT3_SIDEWAYS | 2025-07-16 10:00:00 | 1363.60 | 1380.87 | 1376.70 | Sideways (15m bar) within 4 candles — back to Stage 4 |
| Third Alert (Retest 2) — price touches/crosses EMA400 | 2025-07-16 10:15:00 | 1364.10 | 1377.52 | 1375.56 | EMA400 retest candle locked (from upside) |
| ALERT3_SIDEWAYS | 2025-07-16 10:45:00 | 1365.70 | 1377.52 | 1375.56 | Sideways (15m bar) within 4 candles — back to Stage 4 |
...
### Cycle 19 — BUY (started 2025-07-17 09:15:00)
...
| Second Entry (SELL) — retest2 break (cap 3 attempts) | 2025-07-31 09:15:00 | 1362.80 | 1385.85 | 1389.81 | SELL ENTRY2 attempt 1/4 (v1.4 edge cross+close) |
| Partial book — 50% qty, trail SL → EMA200 | 2025-08-07 09:15:00 | 1294.66 | 1321.40 | 1324.62 | Partial book 0.50 @ 5%; trail SL->EMA200 alert=retest2 |
| Stop hit — per-position SL triggered | 2025-08-07 09:15:00 | 1322.00 | 1321.40 | 1324.62 | SL hit (close>static) qty=0.50 sl=1321.40 alert=retest2 |
...
### Cycle 26 — SELL (started 2025-09-11 12:15:00)
...
| Target hit | 2025-09-29 12:15:00 | 1194.21 | 1225.74 | 1249.41 | Target hit (10%) qty=0.50 alert=retest2 |
...
### Cycle 31 — BUY (started 2025-10-15 12:15:00)
...
### Cycle 33 — BUY (started 2025-11-25 14:15:00)
...
### Cycle 34 — SELL (started 2025-11-27 09:15:00)
...
| Third Alert (Retest 2) — price touches/crosses EMA400 | 2025-12-11 09:15:00 | 920.90 | 919.97 | 925.18 | EMA400 retest candle locked (from downside) |
...
### Cycle 36 — SELL (started 2025-12-17 13:15:00)
...
### Cycle 40 — SELL (started 2026-01-06 12:15:00)
...
| Second Entry (SELL) — retest2 break (cap 3 attempts) | 2026-01-22 10:30:00 | 790.25 | 792.06 | 793.56 | SELL ENTRY2 attempt 2/4 (v1.4 edge cross+close) |
| Second Entry (SELL) — retest2 break (cap 3 attempts) | 2026-01-22 14:30:00 | 791.05 | 790.63 | 792.30 | SELL ENTRY2 attempt 3/4 (v1.4 edge cross+close) |
| Stop hit — per-position SL triggered | 2026-01-23 11:15:00 | 797.95 | 793.96 | 793.46 | Force close (CROSSOVER_FLIP) qty=1.00 alert=retest2 |
| Stop hit — per-position SL triggered | 2026-01-23 11:15:00 | 797.95 | 793.96 | 793.46 | Force close (CROSSOVER_FLIP) qty=1.00 alert=retest2 |

### Cycle 41 — BUY (started 2026-01-23 11:15:00)
...
### Cycle 42 — SELL (started 2026-01-27 13:15:00)
...
### Cycle 44 — SELL (started 2026-02-01 15:15:00)
...
### Cycle 45 — BUY (started 2026-02-02 15:15:00)
...
### Cycle 51 — BUY (started 2026-02-27 14:15:00)
...
| Stop hit — per-position SL triggered | 2026-03-25 14:15:00 | 809.40 | 803.05 | 802.21 | Force close (CROSSOVER_FLIP) qty=1.00 alert=retest2 |

### Cycle 59 — BUY (started 2026-03-25 14:15:00)
...
### Cycle 64 — SELL (started 2026-04-06 11:15:00)
...
### Cycle 66 — SELL (started 2026-04-13 09:15:00)
