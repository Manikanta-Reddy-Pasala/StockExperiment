...
- **Avg / median % per leg:** -0.39% / -1.13%
- **Sum % (uncompounded):** -7.87%

## Direction × Alert breakdown

| Bucket | Legs | Win | Win% | Tgt | SL | Prt | Avg % | Sum % |
|--------|------|-----|------|-----|----|-----|-------|-------|
| BUY (all) | 6 | 1 | 16.7% | 0 | 5 | 1 | 1.52% | 9.1% |
...
| retest2 (combined) | 17 | 0 | 0.0% | 0 | 17 | 0 | -1.31% | -22.2% |
...
| CROSSOVER_SKIP | 2025-03-26 11:15:00 | 360.25 | 333.46 | 333.33 | HTF filter: close below htf_sma |

### Cycle 2 — SELL (started 2025-06-02 10:15:00)
...
### Cycle 5 — BUY (started 2026-01-07 09:15:00)
