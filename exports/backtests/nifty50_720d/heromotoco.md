...
- **Avg / median % per leg:** 9.98% / 15.00%
- **Sum % (uncompounded):** 259.48%

## Direction × Alert breakdown

| Bucket | Legs | Win | Win% | Tgt | SL | Prt | Avg % | Sum % |
|--------|------|-----|------|-----|----|-----|-------|-------|
| BUY (all) | 21 | 12 | 57.1% | 6 | 9 | 6 | 12.20% | 256.2% |
| BUY @ 2nd Alert (retest1) | 4 | 0 | 0.0% | 0 | 4 | 0 | -2.10% | -8.4% |
| BUY @ 3rd Alert (retest2) | 17 | 12 | 70.6% | 6 | 5 | 6 | 15.57% | 264.6% |
| SELL (all) | 5 | 1 | 20.0% | 0 | 4 | 1 | 0.65% | 3.3% |
| SELL @ 2nd Alert (retest1) | 0 | 0 | 0.0% | 0 | 0 | 0 | 0.00% | 0.0% |
| SELL @ 3rd Alert (retest2) | 5 | 1 | 20.0% | 0 | 4 | 1 | 0.65% | 3.3% |
| retest1 (combined) | 4 | 0 | 0.0% | 0 | 4 | 0 | -2.10% | -8.4% |
| retest2 (combined) | 22 | 13 | 59.1% | 6 | 9 | 7 | 12.18% | 267.9% |
...
| Stop hit — per-position SL triggered | 2025-07-11 15:15:00 | 4205.25 | 4280.12 | 4205.25 | SL hit qty=1.00 sl=4205.25 alert=retest1 |
| Stop hit — per-position SL triggered | 2025-07-11 15:15:00 | 4205.25 | 4280.12 | 4205.25 | SL hit qty=1.00 sl=4205.25 alert=retest1 |
| Stop hit — per-position SL triggered | 2025-07-11 15:15:00 | 4205.25 | 4280.12 | 4205.25 | SL hit qty=1.00 sl=4205.25 alert=retest1 |
| Stop hit — per-position SL triggered | 2025-07-11 15:15:00 | 4205.25 | 4280.12 | 4205.25 | SL hit qty=1.00 sl=4205.25 alert=retest1 |
...
| Third Alert (Retest 2) — price touches/crosses EMA400 | 2025-07-31 15:15:00 | 4251.90 | 4305.53 | 4252.44 | EMA400 retest candle locked |
...
| Partial book — 50% qty @ 15%, trail SL → entry | 2025-08-18 09:15:00 | 4874.62 | 4457.77 | 4354.08 | Partial book 0.50 @ 15%; trail SL->entry alert=retest2 |
| Partial book — 50% qty @ 15%, trail SL → entry | 2025-08-18 09:15:00 | 4921.31 | 4457.77 | 4354.08 | Partial book 0.50 @ 15%; trail SL->entry alert=retest2 |
| Partial book — 50% qty @ 15%, trail SL → entry | 2025-08-18 09:15:00 | 4886.81 | 4457.77 | 4354.08 | Partial book 0.50 @ 15%; trail SL->entry alert=retest2 |
| Partial book — 50% qty @ 15%, trail SL → entry | 2025-08-18 09:15:00 | 4904.52 | 4457.77 | 4354.08 | Partial book 0.50 @ 15%; trail SL->entry alert=retest2 |
| Partial book — 50% qty @ 15%, trail SL → entry | 2025-08-18 09:15:00 | 4933.73 | 4457.77 | 4354.08 | Partial book 0.50 @ 15%; trail SL->entry alert=retest2 |
| Target hit — 30% from entry | 2025-09-08 10:15:00 | 5510.44 | 4927.43 | 4679.72 | Target hit (30%) qty=0.50 alert=retest2 |
| Target hit — 30% from entry | 2025-09-08 10:15:00 | 5524.22 | 4927.43 | 4679.72 | Target hit (30%) qty=0.50 alert=retest2 |
| Target hit — 30% from entry | 2025-10-03 11:15:00 | 5544.24 | 5250.59 | 5006.09 | Target hit (30%) qty=0.50 alert=retest2 |
| Target hit — 30% from entry | 2025-10-03 12:15:00 | 5563.22 | 5253.63 | 5008.83 | Target hit (30%) qty=0.50 alert=retest2 |
| Target hit — 30% from entry | 2025-10-03 12:15:00 | 5577.26 | 5253.63 | 5008.83 | Target hit (30%) qty=0.50 alert=retest2 |
...
### Cycle 7 — SELL (started 2026-02-13 14:15:00)
...
| BUY | retest1 | 2025-06-24 10:15:00 | 4311.20 | 2025-07-11 15:15:00 | 4205.25 | STOP_HIT | 1.00 | -2.46% |
| BUY | retest1 | 2025-06-26 15:15:00 | 4281.00 | 2025-07-11 15:15:00 | 4205.25 | STOP_HIT | 1.00 | -1.77% |
| BUY | retest1 | 2025-07-03 10:15:00 | 4284.70 | 2025-07-11 15:15:00 | 4205.25 | STOP_HIT | 1.00 | -1.85% |
| BUY | retest1 | 2025-07-08 12:15:00 | 4305.40 | 2025-07-11 15:15:00 | 4205.25 | STOP_HIT | 1.00 | -2.33% |
