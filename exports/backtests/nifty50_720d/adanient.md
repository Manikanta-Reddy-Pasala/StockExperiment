...
- **Winners / losers:** 9 / 18
- **Target hits / Stop hits / Partials:** 2 / 20 / 5
- **Avg / median % per leg:** 3.55% / -1.54%
- **Sum % (uncompounded):** 95.96%

## Direction × Alert breakdown

| Bucket | Legs | Win | Win% | Tgt | SL | Prt | Avg % | Sum % |
|--------|------|-----|------|-----|----|-----|-------|-------|
| BUY (all) | 4 | 1 | 25.0% | 0 | 4 | 0 | -1.82% | -7.3% |
...
| retest1 (combined) | 8 | 4 | 50.0% | 0 | 6 | 2 | 3.33% | 26.6% |
| retest2 (combined) | 19 | 5 | 26.3% | 2 | 14 | 3 | 3.65% | 69.3% |
