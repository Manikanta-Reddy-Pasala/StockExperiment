...
| Stop hit — per-position SL triggered | 2025-09-19 10:15:00 | 91.82 | 84.21 | 90.79 | SL hit (close>static) qty=1.00 sl=91.60 alert=retest2 |
| Second Entry (SELL) — retest2 break (cap 3 attempts) | 2025-09-19 13:00:00 | 90.44 | 84.34 | 90.79 | SELL ENTRY2 attempt 3/4 (v1.4 edge cross+close) |
| Stop hit — per-position SL triggered | 2025-09-19 14:15:00 | 91.74 | 84.48 | 90.79 | SL hit (close>static) qty=1.00 sl=91.60 alert=retest2 |
| Stop hit — per-position SL triggered | 2025-09-22 09:15:00 | 92.52 | 84.63 | 90.81 | SL hit (close>static) qty=1.00 sl=92.48 alert=retest2 |
| Stop hit — per-position SL triggered | 2025-09-22 09:15:00 | 92.52 | 84.63 | 90.81 | SL hit (close>static) qty=1.00 sl=92.48 alert=retest2 |
| Stop hit — per-position SL triggered | 2025-09-22 09:15:00 | 92.52 | 84.63 | 90.81 | SL hit (close>static) qty=1.00 sl=92.48 alert=retest2 |
| Stop hit — per-position SL triggered | 2025-09-22 09:15:00 | 92.52 | 84.63 | 90.81 | SL hit (close>static) qty=1.00 sl=92.48 alert=retest2 |
| Second Entry (SELL) — retest2 break (cap 3 attempts) | 2025-09-25 09:15:00 | 90.05 | 85.99 | 90.93 | SELL ENTRY2 attempt 4/4 (v1.4 edge cross+close) |
...
| Second Entry (SELL) — retest2 break (cap 3 attempts) | 2025-09-25 10:30:00 | 89.11 | 86.06 | 90.92 | SELL ENTRY2 attempt 1/4 (v1.4 edge cross+close) |
| Partial book — 50% qty, trail SL → EMA200 | 2025-09-26 11:15:00 | 85.55 | 86.13 | 90.76 | Partial book 0.50 @ 5%; trail SL->EMA200 alert=retest2 |
| Partial book — 50% qty, trail SL → EMA200 | 2025-09-26 13:15:00 | 84.65 | 86.10 | 90.70 | Partial book 0.50 @ 5%; trail SL->EMA200 alert=retest2 |
| Stop hit — per-position SL triggered | 2025-10-01 14:15:00 | 86.26 | 85.85 | 90.09 | SL hit (close>ema200) qty=0.50 sl=85.85 alert=retest2 |
| Stop hit — per-position SL triggered | 2025-10-01 14:15:00 | 86.26 | 85.85 | 90.09 | SL hit (close>ema200) qty=0.50 sl=85.85 alert=retest2 |
