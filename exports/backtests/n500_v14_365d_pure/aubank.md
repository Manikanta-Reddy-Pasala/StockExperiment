...
| Stop hit — per-position SL triggered | 2026-03-02 13:15:00 | 951.50 | 987.26 | 972.64 | SL hit (close<static) qty=1.00 sl=952.40 alert=retest2 |
| Stop hit — per-position SL triggered | 2026-03-02 13:15:00 | 951.50 | 987.26 | 972.64 | SL hit (close<static) qty=1.00 sl=952.40 alert=retest2 |
| Stop hit — per-position SL triggered | 2026-03-04 10:15:00 | 936.00 | 985.66 | 972.12 | SL hit (close<static) qty=1.00 sl=944.10 alert=retest2 |
| Stop hit — per-position SL triggered | 2026-03-04 10:15:00 | 936.00 | 985.66 | 972.12 | SL hit (close<static) qty=1.00 sl=944.10 alert=retest2 |
| Stop hit — per-position SL triggered | 2026-03-04 10:15:00 | 936.00 | 985.66 | 972.12 | SL hit (close<static) qty=1.00 sl=944.10 alert=retest2 |
| Stop hit — per-position SL triggered | 2026-03-04 10:15:00 | 936.00 | 985.66 | 972.12 | SL hit (close<static) qty=1.00 sl=944.10 alert=retest2 |
| Third Alert (Retest 2) — price touches/crosses EMA400 | 2026-03-05 14:15:00 | 971.90 | 982.65 | 971.29 | EMA400 retest candle locked (from upside) |
| Second Entry (BUY) — retest2 break (cap 3 attempts) | 2026-03-06 09:15:00 | 977.90 | 982.55 | 971.30 | BUY ENTRY2 attempt 1/4 (v1.4 edge cross+close) |
| Stop hit — per-position SL triggered | 2026-03-09 09:15:00 | 923.30 | 981.05 | 970.98 | SL hit (close<static) qty=1.00 sl=961.55 alert=retest2 |
