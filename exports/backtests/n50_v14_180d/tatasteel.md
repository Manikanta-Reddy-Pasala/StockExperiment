...
- **Winners / losers:** 4 / 13
- **Target hits / Stop hits / Partials:** 4 / 13 / 0
- **Avg / median % per leg:** 0.03% / -1.33%
...
|--------|------|-----|------|-----|----|-----|-------|-------|
| BUY (all) | 12 | 4 | 33.3% | 4 | 8 | 0 | 0.45% | 5.4% |
| BUY @ 2nd Alert (retest1) | 0 | 0 | 0.0% | 0 | 0 | 0 | 0.00% | 0.0% |
| BUY @ 3rd Alert (retest2) | 12 | 4 | 33.3% | 4 | 8 | 0 | 0.45% | 5.4% |
| SELL (all) | 5 | 0 | 0.0% | 0 | 5 | 0 | -0.99% | -4.9% |
| SELL @ 2nd Alert (retest1) | 0 | 0 | 0.0% | 0 | 0 | 0 | 0.00% | 0.0% |
| SELL @ 3rd Alert (retest2) | 5 | 0 | 0.0% | 0 | 5 | 0 | -0.99% | -4.9% |
| retest1 (combined) | 0 | 0 | 0.0% | 0 | 0 | 0 | 0.00% | 0.0% |
| retest2 (combined) | 17 | 4 | 23.5% | 4 | 13 | 0 | 0.03% | 0.5% |
...
| Stop hit — per-position SL triggered | 2025-12-23 11:15:00 | 171.04 | 169.66 | 169.99 | SL hit (close>static) qty=1.00 sl=170.65 alert=retest2 |
| Stop hit — per-position SL triggered | 2025-12-23 11:15:00 | 171.04 | 169.66 | 169.99 | SL hit (close>static) qty=1.00 sl=170.65 alert=retest2 |
| ALERT3_SIDEWAYS | 2025-12-23 12:00:00 | 171.04 | 169.66 | 169.99 | Sideways (15m bar) within 4 candles — back to Stage 4 |
| Third Alert (Retest 2) — price touches/crosses EMA400 | 2025-12-23 12:15:00 | 170.76 | 169.67 | 169.99 | EMA400 retest candle locked (from downside) |
| Second Entry (SELL) — retest2 break (cap 3 attempts) | 2025-12-24 14:00:00 | 170.44 | 169.76 | 170.03 | SELL ENTRY2 attempt 1/4 (v1.4 edge cross+close) |
| Stop hit — per-position SL triggered | 2025-12-29 09:15:00 | 172.70 | 169.74 | 170.00 | SL hit (close>static) qty=1.00 sl=171.35 alert=retest2 |
...
| Stop hit — per-position SL triggered | 2026-03-13 09:15:00 | 185.67 | 199.26 | 193.70 | SL hit (close<static) qty=1.00 sl=187.03 alert=retest2 |
| Stop hit — per-position SL triggered | 2026-03-13 09:15:00 | 185.67 | 199.26 | 193.70 | SL hit (close<static) qty=1.00 sl=187.03 alert=retest2 |
| ALERT3_SIDEWAYS | 2026-03-13 10:00:00 | 185.67 | 199.26 | 193.70 | Sideways (15m bar) within 4 candles — back to Stage 4 |
| Third Alert (Retest 2) — price touches/crosses EMA400 | 2026-03-17 14:15:00 | 195.24 | 197.22 | 193.13 | EMA400 retest candle locked (from upside) |
| Second Entry (BUY) — retest2 break (cap 3 attempts) | 2026-03-20 09:15:00 | 197.67 | 196.72 | 193.17 | BUY ENTRY2 attempt 1/4 (v1.4 edge cross+close) |
| Second Entry (BUY) — retest2 break (cap 3 attempts) | 2026-03-20 15:00:00 | 196.70 | 196.77 | 193.30 | BUY ENTRY2 attempt 2/4 (v1.4 edge cross+close) |
| Stop hit — per-position SL triggered | 2026-03-23 09:15:00 | 187.50 | 196.67 | 193.28 | SL hit (close<static) qty=1.00 sl=193.10 alert=retest2 |
| Stop hit — per-position SL triggered | 2026-03-23 09:15:00 | 187.50 | 196.67 | 193.28 | SL hit (close<static) qty=1.00 sl=193.10 alert=retest2 |
| Second Entry (BUY) — retest2 break (cap 3 attempts) | 2026-03-25 13:30:00 | 196.49 | 195.73 | 193.08 | BUY ENTRY2 attempt 3/4 (v1.4 edge cross+close) |
| Stop hit — per-position SL triggered | 2026-03-30 09:15:00 | 190.00 | 195.57 | 193.12 | SL hit (close<static) qty=1.00 sl=193.10 alert=retest2 |
| Second Entry (BUY) — retest2 break (cap 3 attempts) | 2026-04-01 09:15:00 | 197.70 | 195.36 | 193.09 | BUY ENTRY2 attempt 4/4 (v1.4 edge cross+close) |
| Third Alert (Retest 2) — price touches/crosses EMA400 | 2026-04-02 09:15:00 | 188.82 | 195.35 | 193.18 | EMA400 retest candle locked (from upside) |
| Stop hit — per-position SL triggered | 2026-04-02 09:15:00 | 188.82 | 195.35 | 193.18 | SL hit (close<static) qty=1.00 sl=193.10 alert=retest2 |
| ALERT3_SIDEWAYS | 2026-04-02 10:00:00 | 188.82 | 195.35 | 193.18 | Sideways (15m bar) within 4 candles — back to Stage 4 |
| Third Alert (Retest 2) — price touches/crosses EMA400 | 2026-04-02 14:15:00 | 194.59 | 195.16 | 193.13 | EMA400 retest candle locked (from upside) |
| ALERT3_SIDEWAYS | 2026-04-02 14:45:00 | 193.74 | 195.16 | 193.13 | Sideways (15m bar) within 4 candles — back to Stage 4 |
| Third Alert (Retest 2) — price touches/crosses EMA400 | 2026-04-06 09:15:00 | 194.85 | 195.14 | 193.14 | EMA400 retest candle locked (from upside) |
| Second Entry (BUY) — retest2 break (cap 3 attempts) | 2026-04-06 12:45:00 | 195.45 | 195.14 | 193.17 | BUY ENTRY2 attempt 1/4 (v1.4 edge cross+close) |
| Second Entry (BUY) — retest2 break (cap 3 attempts) | 2026-04-06 13:45:00 | 195.44 | 195.14 | 193.18 | BUY ENTRY2 attempt 2/4 (v1.4 edge cross+close) |
| Second Entry (BUY) — retest2 break (cap 3 attempts) | 2026-04-07 11:15:00 | 195.54 | 195.17 | 193.23 | BUY ENTRY2 attempt 3/4 (v1.4 edge cross+close) |
| Second Entry (BUY) — retest2 break (cap 3 attempts) | 2026-04-07 11:45:00 | 195.59 | 195.16 | 193.24 | BUY ENTRY2 attempt 4/4 (v1.4 edge cross+close) |
| Target hit | 2026-04-27 11:15:00 | 215.00 | 203.75 | 199.06 | Target hit (10%) qty=1.00 alert=retest2 |
| Target hit | 2026-04-27 11:15:00 | 214.98 | 203.75 | 199.06 | Target hit (10%) qty=1.00 alert=retest2 |
| Target hit | 2026-04-28 09:15:00 | 215.09 | 204.27 | 199.44 | Target hit (10%) qty=1.00 alert=retest2 |
| Target hit | 2026-04-28 09:15:00 | 215.15 | 204.27 | 199.44 | Target hit (10%) qty=1.00 alert=retest2 |
